...
describe("favorite blog", () => {
  ...
  test("when list has one blog, is the blog itself", () => {
  ...
  test("when list is long, calculated right", () => {
...
describe("most blogs", () => {
  ...
  test("when list is long, is calculated right", () => {
...
describe("most likes", () => {
  ...
  test("when list has one blog, equals the likes of the blog itself", () => {
